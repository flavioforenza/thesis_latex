\begin{subsection}{Steps 1, 2, 3 e 4}
  \begin{frame}{MODELLI INSEGNANTE E STUDENTI}
    ...
    \begin{minipage}{\linewidth}
      ...
      \end{minipage}
    \end{minipage}
    \footnotetext[1]{\scriptsize \bfseries Iper-parametro \emph{width-multiplier} ($\alpha$). Utile alla gestione del numero dei canali, di input e di output, di ogni layer convoluzionale.}
  \end{frame}
\end{subsection}
