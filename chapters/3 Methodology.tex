...
\subsubsection{1. Definizione modelli Insegnante e Studente}
...
Shot-Detector (DSSD)\index{Distilled-Single-Shot-Detector (DSSD)}}}}"(Fig. \ref{DSSD_archs}), costituisce l'emblema di tutti gli sforzi fin qui 
