...
performance\index{performance} su tre diverse architetture\index{architetture}, ha permesso di raggiungere un 
...
bisogna esaminare tutta la letteratura basata sui sistemi intelligenti\index{intelligenti} che 
...
segmentation})\index{semantic segmentation}. L'object detection consiste nell'identificare\index{identificare} e localizzare\index{localizzare} vari 
...
hardware differenti, come telecamere\index{telecamere}, stereo-camere\index{stereo-camere} e radar\index{radar}, richiede 
...
capacità computazionali\index{computazionali}, soprattutto se l'argomento riguarda la sicurezza. 
...
dataset\index{dataset} utilizzati, vengono visualizzati tutti i risultati raggiunti dal modello 
proposto, in termini di accuratezza\index{accuratezza}, numero di parametri\index{parametri}, dimensioni e 
benchmarks\index{benchmarks}, corredati da una lista delle architetture utilizzate. Infine, 
