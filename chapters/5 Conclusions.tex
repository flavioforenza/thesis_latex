...
\label{Capitolo5}
\thispagestyle{empty}
Considerati i progressi svolti nelle tecniche di guida autonoma\index{autonoma} negli ultimi 
...
utilizzo di risorse\index{risorsa} computazionali\index{computazionale} e energetiche. Il modello "\emph{Distilled-Single-
Shot-Detector (DSSD)}"\index{Distilled-Single-Shot-Detector (DSSD)} proposto, rappresenta una base di partenza da 
...
più economici, tipo quelli embedded\index{embedded}, può rappresentare una via da intraprendere.
...
l'ottimizzazione di un qualsiasi sistema intelligente\index{intelligenza}, governante anche la 
componente dei Sistemi Avanzati di Assistenza alla Guida (\emph{Advanced Driver 
Assistance Systems - ADAS})\index{advanced driver assistance systems (ADAS)},  rappresenta il raggiungimento di un obiettivo 
...
modello proposto fornisce una capacità di rilevamento\index{rilevamento} degli oggetti soddisfacente 
...
nuova rete studente distillata differente da quella utilizzata in questa ricerca. 
...
generazione di un modello compresso tramite la tecnica di pruning\index{Pruning}, su cui 
applicare successivamente la tecnica di Knowledge Distillation\index{Knowledge Distillation}. L'utilizzo 
...
guida autonoma\index{autonoma} possano maturare al punto da incrementare il loro livello 
