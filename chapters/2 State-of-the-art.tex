...
\begin{enumerate}
    \item \emph{Feed Forward Neural Netowroks (FNN)}
...
\subsection{Feed Forward Neural Netowroks}
...
\subsection{Convolutional Neural Netoworks}\label{RNC}
...
\begin{figure}
    \centering
    \includegraphics[width = \linewidth]{state RNN.png}
    \centering
    \caption{Esempio di stato di un neurone in una RNN.}
