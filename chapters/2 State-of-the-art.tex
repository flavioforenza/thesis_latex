...
\emph{Back-Propagation}\index{back-propagation}. La complessità di questo tipo di apprendimento deriva dalla 
quantità di dati presenti nel training set. Affinché la rete riesca a \index{generalizzare} al 
...
il processo di apprendimento\index{apprendimento} (backpropagation)\index{back-propagation} del modello\index{modello} semplificando 
...
saturazione del gradiente\index{gradiente}.
