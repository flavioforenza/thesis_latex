...
inferiori, in modo che questi possano essere concatenati. La figura (\ref{parsenet}) riassume i passaggi precedenti.
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9\linewidth]{parsenet.png}
    \centering
