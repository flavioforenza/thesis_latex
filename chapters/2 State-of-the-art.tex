...
corrispondenti ai pesi, e la regione dell’immagine in cui si trova. Il numero di 
feature map sarà uguale al numero di filtri applicato sull’immagine. La generazione 
di ogni feature map dipende da quattro tipi di parametri, detti \emph{iperparametri}:
\begin{enumerate}
    \item \emph{Profondità (depth)}: numero di filtri usati durante la convoluzione;
    ...
    la matrice di partenza, rappresentate l’immagine, deve essere riempita di 
    zeri presso le sue estremità.
\end{enumerate}
