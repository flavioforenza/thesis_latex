...
Neural Networks (CNN)}\index{Convolutional Neural Netwrok - CNN}, le \emph{Recurrent Neural Networks (RNN)} come le \emph{Long 
...
estrarre le features di alto livello tipo i contorni, classificazione\index{classificazione}, riconoscimento 
...
Linearità (ReLU)}}, {\bfseries{Pooling (o Sub Sampling)}} e {\bfseries{Classificazione}}\index{classificazione} (nei layer\index{layer} 
fully connected). 
\begin{figure}
    \centering
...
sul punteggio di classificazione\index{classificazione} finale. Ogni feature map appartiene a un layer\index{layer} 
