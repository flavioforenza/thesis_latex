...
\begin{figure}
    ...
    \centering
    \caption{Road Segmentation proveniente dai diversi modelli: (a) Up-Conv-Poly, (b) LidCamNet e (c) DEEP-DIG. Il oclore verde indica una segmentazione (True-Positive), rosso indica una rilevazione False-Negative e Blu una rilevazione False-Positive}
    \label{road-det}
\end{figure}
